...
public class MainActivity extends Activity 
{
   ...
   private static final NumberFormat personFormat = NumberFormat.getInstance();
   ...
   private Button withTax;
   private Button withoutTax;
   private boolean taxFlag = true;
   private TextView amountOfPeopleDisplayTextView;
   ...
   protected void onCreate(Bundle savedInstanceState)
   {
      ...
      amountOfPeopleDisplayTextView = (TextView) findViewById(R.id.amountOfPeopleEditText);
      ...
      EditText amountOfPeopleEditText = (EditText) findViewById(R.id.amountOfPeopleEditText);
      amountOfPeopleEditText.addTextChangedListener(amountOfPeopleEditTextWatcher);
   ...
   private void updateCustom() 
   {
      ...
      if (taxFlag == true) {
      customTip = (billAmount * 0.25 + billAmount) * customPercent;
      }
      else {
      ...
      perPersonAmount.setText(String.valueOf(currencyFormat.format(customTotal / amountOfPeople)));
   } // end method updateCustom
   
   public void calculateWithTax(View view) {
	   taxFlag = true;
	   updateStandard();
	   updateCustom();
	   }
   public void calculateWithoutTax(View view) {
	   taxFlag = false;
	   updateStandard();
	   updateCustom();
	   }
   ...
   private TextWatcher amountOfPeopleEditTextWatcher = new TextWatcher() {
	   @Override
	   ...
	   // display currency formatted bill amount
	   amountOfPeopleDisplayTextView.setText(String.valueOf(amountOfPeople));
	   updateStandard(); // update the 15% tip TextViews
	   updateCustom(); // update the custom tip TextViews
	   } // end method onTextChanged
	   @Override
